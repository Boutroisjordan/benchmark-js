...
import { createNewFranchise, getFranchises } from '@/src/controllers/franchises.controller';
import {validateData} from "@/src/middlewares/validatorMiddlewares";
import {createFranchiseSchema} from "@/src/validators/franchises.validator"
